...
<html>
  <head>
	...
	<script type="text/javascript">thisModel=8;gameType=1;gameName="heart"</script>
</head>
	    ...
	    <div class="right_all">
	    	<div class="game_win win">
	    		<div class="win_head">
    				...
    				<p class="win_head_title" ondblclick="successful()">心形 数独</p>
	    				...
	    				<div class="game">
							<div class="game_main">
								<div class="court left_top">
									...
									<div class="cell son_middle_middle row2 column2 init"><p class="number_p">2</p></div>
									<div class="cell son_right_middle row2 column3 init"><p class="number_p">3</p></div>
									<div class="clear"></div>
									<div class="cell son_left_bottom row3 column1 init"><p class="number_p">1</p></div>
								...
								<div class="court middle_top">
									...
									<div class="clear"></div>
									<div class="cell son_left_bottom row3 column4 init"><p class="number_p">4</p></div>
									<div class="cell son_middle_bottom row3 column5 normal"><p class="number_p"></p></div>
									<div class="cell son_right_bottom row3 column6 init"><p class="number_p">6</p></div>
									<div class="clear"></div>
								</div>
								<div class="court right_top">
									...
									<div class="clear"></div>
									<div class="cell son_left_middle row2 column7 init"><p class="number_p">7</p></div>
									<div class="cell son_middle_middle row2 column8 init"><p class="number_p">8</p></div>
									...
									<div class="cell son_right_bottom row3 column9 init"><p class="number_p">9</p></div>
									<div class="clear"></div>
								</div>
								<div class="clear"></div>
								<div class="court left_middle">
									...
									<div class="cell son_middle_bottom row6 column2 init"><p class="number_p">6</p></div>
								...
								<div class="court middle_middle">
									...
									<div class="cell son_middle_top row4 column5 init"><p class="number_p">5</p></div>
								...
								<div class="court right_middle">
									...
									<div class="cell son_right_middle row5 column9 init"><p class="number_p">6</p></div>
									<div class="clear"></div>
									<div class="cell son_left_bottom row6 column7 normal"><p class="number_p"></p></div>
									<div class="cell son_middle_bottom row6 column8 init"><p class="number_p">9</p></div>
								...
								<div class="court left_bottom">
									...
									<div class="cell son_right_top row7 column3 init"><p class="number_p">5</p></div>
									<div class="clear"></div>
								...
								<div class="court middle_bottom">
									...
									<div class="clear"></div>
									<div class="cell son_left_middle row8 column4 init"><p class="number_p">3</p></div>
									<div class="cell son_middle_middle row8 column5 normal"><p class="number_p"></p></div>
									<div class="cell son_right_middle row8 column6 init"><p class="number_p">1</p></div>
									<div class="clear"></div>
									<div class="cell son_left_bottom row9 column4 normal"><p class="number_p"></p></div>
									<div class="cell son_middle_bottom row9 column5 init"><p class="number_p">9</p></div>
									<div class="cell son_right_bottom row9 column6 normal"><p class="number_p"></p></div>
									<div class="clear"></div>
								</div>
								<div class="court right_bottom">
									<div class="cell son_left_top row7 column7 init"><p class="number_p">8</p></div>
