...
<html>
  <head>
	...
	<script type="text/javascript">thisModel=8;gameType=1;gameName="smile"</script>
</head>
	    ...
	    <div class="right_all">
	    	<div class="game_win win">
	    		<div class="win_head">
    				...
    				<p class="win_head_title" ondblclick="successful()">笑脸 数独</p>
	    				...
	    				<div class="game">
							<div class="game_main">
								<div class="court left_top">
									...
									<div class="cell son_right_top row1 column3 init"><p class="number_p">9</p></div>
									<div class="clear"></div>
									...
									<div class="clear"></div>
									<div class="cell son_left_bottom row3 column1 init"><p class="number_p">6</p></div>
									<div class="cell son_middle_bottom row3 column2 normal"><p class="number_p"></p></div>
									<div class="cell son_right_bottom row3 column3 normal"><p class="number_p"></p></div>
									<div class="clear"></div>
								</div>
								<div class="court middle_top">
									<div class="cell son_left_top row1 column4 init"><p class="number_p">7</p></div>
									<div class="cell son_middle_top row1 column5 init"><p class="number_p">3</p></div>
									<div class="cell son_right_top row1 column6 init"><p class="number_p">6</p></div>
									<div class="clear"></div>
									...
									<div class="cell son_right_middle row2 column6 normal"><p class="number_p"></p></div>
									<div class="clear"></div>
								...
								<div class="court right_top">
									<div class="cell son_left_top row1 column7 init"><p class="number_p">8</p></div>
									...
									<div class="cell son_middle_middle row2 column8 init"><p class="number_p">9</p></div>
									...
									<div class="cell son_right_bottom row3 column9 init"><p class="number_p">4</p></div>
									<div class="clear"></div>
								</div>
								<div class="clear"></div>
								<div class="court left_middle">
									<div class="cell son_left_top row4 column1 init"><p class="number_p">7</p></div>
									...
									<div class="clear"></div>
									<div class="cell son_left_middle row5 column1 init"><p class="number_p">9</p></div>
									...
									<div class="clear"></div>
									<div class="cell son_left_bottom row6 column1 init"><p class="number_p">8</p></div>
									<div class="cell son_middle_bottom row6 column2 normal"><p class="number_p"></p></div>
									<div class="cell son_right_bottom row6 column3 init"><p class="number_p">3</p></div>
									<div class="clear"></div>
								</div>
								<div class="court middle_middle">
									<div class="cell son_left_top row4 column4 init"><p class="number_p">8</p></div>
									<div class="cell son_middle_top row4 column5 normal"><p class="number_p"></p></div>
									<div class="cell son_right_top row4 column6 init"><p class="number_p">9</p></div>
									<div class="clear"></div>
								...
								<div class="court right_middle">
									...
									<div class="cell son_right_top row4 column9 init"><p class="number_p">5</p></div>
									<div class="clear"></div>
									...
									<div class="cell son_right_middle row5 column9 init"><p class="number_p">8</p></div>
									<div class="clear"></div>
									<div class="cell son_left_bottom row6 column7 init"><p class="number_p">9</p></div>
								...
								<div class="court left_bottom">
									<div class="cell son_left_top row7 column1 init"><p class="number_p">5</p></div>
									<div class="cell son_middle_top row7 column2 normal"><p class="number_p"></p></div>
									<div class="cell son_right_top row7 column3 normal"><p class="number_p"></p></div>
									<div class="clear"></div>
									<div class="cell son_left_middle row8 column1 normal"><p class="number_p"></p></div>
									<div class="cell son_middle_middle row8 column2 init"><p class="number_p">9</p></div>
									<div class="cell son_right_middle row8 column3 normal"><p class="number_p"></p></div>
									<div class="clear"></div>
									<div class="cell son_left_bottom row9 column1 normal"><p class="number_p"></p></div>
									<div class="cell son_middle_bottom row9 column2 normal"><p class="number_p"></p></div>
									<div class="cell son_right_bottom row9 column3 init"><p class="number_p">8</p></div>
									<div class="clear"></div>
								</div>
								<div class="court middle_bottom">
									<div class="cell son_left_top row7 column4 init"><p class="number_p">4</p></div>
									<div class="cell son_middle_top row7 column5 init"><p class="number_p">8</p></div>
									<div class="cell son_right_top row7 column6 init"><p class="number_p">7</p></div>
									<div class="clear"></div>
									<div class="cell son_left_middle row8 column4 normal"><p class="number_p"></p></div>
									...
									<div class="clear"></div>
									<div class="cell son_left_bottom row9 column4 init"><p class="number_p">9</p></div>
									<div class="cell son_middle_bottom row9 column5 init"><p class="number_p">6</p></div>
									<div class="cell son_right_bottom row9 column6 init"><p class="number_p">2</p></div>
									<div class="clear"></div>
								</div>
								<div class="court right_bottom">
									...
									<div class="cell son_right_top row7 column9 init"><p class="number_p">9</p></div>
									<div class="clear"></div>
									<div class="cell son_left_middle row8 column7 normal"><p class="number_p"></p></div>
									<div class="cell son_middle_middle row8 column8 init"><p class="number_p">8</p></div>
									<div class="cell son_right_middle row8 column9 normal"><p class="number_p"></p></div>
									<div class="clear"></div>
									<div class="cell son_left_bottom row9 column7 init"><p class="number_p">5</p></div>
									<div class="cell son_middle_bottom row9 column8 normal"><p class="number_p"></p></div>
									<div class="cell son_right_bottom row9 column9 normal"><p class="number_p"></p></div>
									<div class="clear"></div>
								</div>
								<div class="clear"></div>
							</div>
	    		...
	    		<div class="win_bottom">
	    			...
	    			<div class="game_info">
	    				...
	    				<p><span class="lable game_level_lable"></span><span class="game_level">骨灰级</span></p>
