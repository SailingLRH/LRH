...
//	minChangeSize : 50,
	zIndex : 811213,
	items : [
		'selectall', 'bold', 'italic', 'underline', 'strikethrough', 'subscript', 'superscript','|', 
		'forecolor', 'hilitecolor', 'justifyleft', 'justifycenter', 'justifyright', 'justifyfull', 'lineheight', '|', 
		'fontname', 'fontsize', 'formatblock', 'insertorderedlist', 'insertunorderedlist', 'indent', 'outdent', '|',
		'cut', 'copy', 'paste', 'plainpaste', 'wordpaste', 'removeformat', '|',
		'code', 'source', 'clearhtml', 'template','quickformat', 'hr', 'table', '|', 
		'emoticons', 'image', 'multiimage', 'flash', 'media', 'insertfile', 'baidumap', 'pagebreak', 
		'link', 'unlink', 'anchor', '|', 'undo', 'redo', 'preview', 'print'
	],
...
//	layout : '<div class="container"><div class="toolbar"></div><div class="edit"></div><div class="statusbar"></div></div>'
	layout : '<div class="container"><div class="toolbar"></div><div class="edit"></div></div>'//去掉下面的拖动条,注意要去掉全屏按钮,否则报错
};
...
_extend(KCmd, {
	...
	insertimage : function(url, title, width, height, border, align) {
		...
		var html = '<img class="editor_insert_img" src="' + _escape(url) + '" data-ke-src="' + _escape(url) + '" ';
		if (width) {
...
function _getInitHtml(themesPath, bodyClass, cssPath, cssData) {
	var arr = [
		...
		'.editor_insert_img{max-height: 300px;max-width: 300px;border: 6px #ffffff solid;margin:5px;'+
		'-moz-box-shadow:0px 0px 10px #252525;-webkit-box-shadow:0px 0px 10px #252525;box-shadow:0px 0px 10px #252525;}',
		'img {border:0;}',
